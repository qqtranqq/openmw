...
local function onHit(data)
    print('COMBAT LOCAL onHit called: successful=' .. tostring(data.successful) .. ' healthDmg=' .. tostring(getDamage(data, 'health')))
    ...
    print('COMBAT LOCAL calling _onHit with damage: ' .. tostring(getDamage(data, 'health')))
